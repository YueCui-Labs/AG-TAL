...
from nnunetv2.training.loss.compound_SkelRecall_loss import DC_SkelREC_and_CE_loss
...
class nnUNetTrainerSkeletonRecallNoMirroring(nnUNetTrainer):
...
class nnUNetTrainerSkeletonRecall_ResEncoder_NoMirroring(nnUNetTrainerSkeletonRecallNoMirroring):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda')):
        super().__init__(plans, configuration, fold, dataset_json, unpack_dataset, device)
        self.weight_srec = 1 # This is the default value, you can change it if you want
        ...
        # self.num_epochs = 100
        self.num_epochs = 200 #�ĳ�160��epoch�����ڲ���һ��
        if self.label_manager.has_regions:
            raise NotImplementedError("trainer not implemented for regions")
